...
import org.bebrb.server.net.CommandGetRecord.Response;
import org.bebrb.server.net.CommandOpenReferenceView.Page;
...
public class CommandGetRecords extends Command {
	...
	public void solution(OutputStream out) throws WriteStreamException,
		...
		if(pages==null)
			throw new ExecuteException("InternalError",238957);
